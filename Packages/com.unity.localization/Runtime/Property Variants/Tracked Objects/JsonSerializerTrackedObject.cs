...
namespace UnityEngine.Localization.PropertyVariants.TrackedObjects
{
    ...
    public abstract class JsonSerializerTrackedObject : TrackedObject
    {
        ...
        class DeferredJsonObjectOperation
        {
            ...
            {
                jsonValue.Value = GetObjectReferenceId(asyncOperationHandle.Result);
        ...
        static object GetObjectReferenceId(Object obj)
        {
            if (obj == null)
                return 0;
            ...
            foreach (var property in TrackedProperties)
            {
                ...
                switch (property)
                {
                    ...
                    case ITrackedPropertyValue<Object> objectProperty:
                    {
                        ...
                        jsonProperty.Value = GetObjectReferenceId(value);
                        propertyChanged = true;
                        break;
                    }
                    ...
                    case LocalizedAssetProperty localizedAssetProperty:
                    {
                        ...
                        if (assetOp.IsDone)
                        {
                            ...
                            jsonProperty.Value = GetObjectReferenceId(result);
