...
namespace UI.Windows.GameScreen.History.HistoryProduction
{
    ...
    public class HistoryProductionController
    {
        ...
        /// </summary>
        protected virtual ProductionBase[] PlayerProductionInfos() => Array.Empty<ProductionBase>();
        ...
        /// </summary>
        private bool CheckAnyProduction(in ProductionBase[] productionInfo)
        {
        ...
        /// </summary>
        private bool ProductionIsUpdated(in ProductionBase[] productionInfo)
        ...
        /// </summary>
        private void GenerateNewItems(in ProductionBase[] productionInfo)
        {
